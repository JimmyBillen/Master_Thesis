...
ax.text(0.4, 0.4, r'$\dot{y}<0$'+',\n'+r'$\dot{x}<0$', color='black', 
        bbox=dict(facecolor='w', edgecolor='black', boxstyle='round', alpha=0.5))
ax.text(0.55, 0.4, r'$\dot{y}>0$'+',\n'+r'$\dot{x}<0$', color='black', 
        bbox=dict(facecolor='w', edgecolor='black', boxstyle='round', alpha=0.5))
ax.text(0.4, 0.24, r'$\dot{y}<0$'+',\n'+r'$\dot{x}>0$', color='black', 
        bbox=dict(facecolor='w', edgecolor='black', boxstyle='round', alpha=0.5 ))
ax.text(0.55, 0.24, r'$\dot{y}>0$'+',\n'+r'$\dot{x}>0$', color='black', 
        bbox=dict(facecolor='w', edgecolor='black', boxstyle='round', alpha=0.5))
...
plt.savefig(r"C:\Users\jimmy\OneDrive\Documents\Universiteit\KULeuven\Masterproef\Thesis_Fig\BasicsToDynamicalSystems\LV_phaseportrait_trajectory.png")
