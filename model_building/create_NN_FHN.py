...
def save_data_in_dataframe(train_loss, validation_loss, nodes, layers, learning_rate, normalization_method, activation_function, model, option, mean_std):
    ...
    name_file_add_on = f"_{TAU}_{NUM_OF_POINTS}"
...
# -------------------------------------- NEXT PLANNED: -------------------------------------------------------------------------------------------
    remake_dataframe = input(f"Are you sure you want to work with tau={TAU} and numpoints={NUM_OF_POINTS}? Type 'yes' ")

    if remake_dataframe == "yes":
        pass
    else:
        assert False, f'not desired TAU: {TAU}'
...
# ================================
    ...
    for seed in range(0,40):
        ...
        # create_neural_network_and_save(normalization_method='no-norm', activation_function='relu', nodes_per_layer = [8,8], num_layers=2, learning_rate=0.01, epochs=500, option='option_3', seed=seed)
        ...
        # create_neural_network_and_save(normalization_method='no-norm', activation_function='tanh', nodes_per_layer = [8,8], num_layers=2, learning_rate=0.01, epochs=500, option='option_3', seed=seed)


        print("Elapsed time second mini part", time.time() - start_time, "seconds \n\n")

        print("Elapsed time third mini part", time.time() - start_time, "seconds \n\n")

        # create_neural_network_and_save(normalization_method='no-norm', activation_function='sigmoid', nodes_per_layer = [8,8], num_layers=2, learning_rate=0.01, epochs=500, option='option_3', seed=seed)
#
        # create_neural_network_and_save(normalization_method='z-score', activation_function='relu', nodes_per_layer = [8,8], num_layers=2, learning_rate=0.01, epochs=500, option='option_3', seed=seed)

        # create_neural_network_and_save(normalization_method='z-score', activation_function='tanh', nodes_per_layer = [8,8], num_layers=2, learning_rate=0.01, epochs=500, option='option_3', seed=seed)

        # create_neural_network_and_save(normalization_method='z-score', activation_function='sigmoid', nodes_per_layer = [8,8], num_layers=2, learning_rate=0.01, epochs=500, option='option_3', seed=seed)
#
        ...
        # create_neural_network_and_save(normalization_method='min-max', activation_function='tanh', nodes_per_layer = [8,8], num_layers=2, learning_rate=0.01, epochs=500, option='option_3', seed=seed)
...
# ================================
    ...
    #     print(f"\n ROUND NUMBER STARTING {q} \n")
    #     start_time = time.time()

    #     create_neural_network_and_save(normalization_method='min-max', activation_function='relu', nodes_per_layer = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4], num_layers=16, learning_rate=0.01, epochs=500, option='option_3')
    #     create_neural_network_and_save(normalization_method='min-max', activation_function='sigmoid', nodes_per_layer = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4], num_layers=16, learning_rate=0.01, epochs=500, option='option_3')

    #     end_time = time.time()
    #     elapsed_time = end_time - start_time
    #     print("Elapsed time mini part", elapsed_time, "seconds \n\n")

    #     create_neural_network_and_save(normalization_method='min-max', activation_function='relu', nodes_per_layer = [8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8], num_layers=16, learning_rate=0.01, epochs=500, option='option_3')
    #     create_neural_network_and_save(normalization_method='min-max', activation_function='sigmoid', nodes_per_layer = [8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8], num_layers=16, learning_rate=0.01, epochs=500, option='option_3')

    #     create_neural_network_and_save(normalization_method='min-max', activation_function='relu', nodes_per_layer = [16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16], num_layers=16, learning_rate=0.01, epochs=500, option='option_3')
    #     create_neural_network_and_save(normalization_method='min-max', activation_function='sigmoid', nodes_per_layer = [16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16], num_layers=16, learning_rate=0.01, epochs=500, option='option_3')
...
1. Neural Network Training: 
    ...
    - [100 epochs]: 
        ...
        - Total time for 9 configurations: 432 seconds (48 seconds per configuration)
        - (for option_4 it took 300 seconds per configuration, 3000 seconds for 9, and 16 hours 9x20)
    
    - [500 epochs]:
        - Time per configuration: 210 seconds
        - Total time for 6 configurations: 1310 seconds
        - Total time for 9 configurations: 2000 seconds
