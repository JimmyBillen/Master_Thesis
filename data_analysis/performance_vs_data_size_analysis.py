# This script visualizes the performance (nullcline error, validation error and pearson correlation coefficient)
# in function of the data size used to train the neural network.
# Results are discussed in Section 4.6 of the thesis.
# 
# The nullcline error and PCC were calculated in the script modules_change_size and saved in changing_data_size
# 
...
for num_points in num_points_list:
    ...
    file_path = os.path.join(script_dir, 'changing_data_size', input_file_path)
...
print("Total running time ", len(times), "took", sum(times), "seconds or hours:", sum(times)/3600)
...
if plot_next_to_eachother:
    ...
    ax[0].set_title("Training Time 40 Runs (min)") # 7k jumps out due to a break in calculations (idle laptop)
