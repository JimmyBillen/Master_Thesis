...
if __name__ == '__main__':
    ...
    save_one_norm_two_act_MSE_vs_VAL(learning_rate=0.01, nodes=2*[16], layers=2, max_epochs=499, option='option_3', normalization_method=['min-max'], activation_functions=['sigmoid'], amount_per_parameter=20, save=True)
